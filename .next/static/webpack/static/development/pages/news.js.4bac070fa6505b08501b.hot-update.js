...
var News = function News() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    if (cache.news) {
      ...
      setDisplayedNews(currentNews.slice(0, pageToDisplay));
      setLoader(false);
      if (Object(_helpers_Shared__WEBPACK_IMPORTED_MODULE_3__["dateDiff"])(new Date(cache.newsDate), new Date()).min > 5) fetchDatas();
    } else {
      fetchDatas();
    }
  }, []);
  ...
  return __jsx("div", {
    ...
    return __jsx(_components_News_Card__WEBPACK_IMPORTED_MODULE_6__["default"], {
      key: index,
      news: item,
      __source: {
        fileName: _jsxFileName,
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          news = Object(_helpers_News__WEBPACK_IMPORTED_MODULE_2__["getApiNews"])(context);
...
//# sourceMappingURL=news.js.4bac070fa6505b08501b.hot-update.js.map