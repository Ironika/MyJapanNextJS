...
function formatJsonJournalDuGeek(json) {
    ...
    for(var i = 0; i < items.length; i++) {
        ...
        const tag = (items[i].category && items[i].category[0]) ? items[i].category[0]['_cdata'].toUpperCase() : 'JournalDuGeek'.toUpperCase()
        const desc = items[i].description['_cdata']
...
function formatJsonBegeek(json) {
    ...
    for(var i = 0; i < items.length; i++) {
        ...
        const tag = (items[i].category && items[i].category[1]) ? items[i].category[1]['_cdata'].toUpperCase() : 'BeGeek'.toUpperCase()
        const desc = items[i].description['_cdata']
