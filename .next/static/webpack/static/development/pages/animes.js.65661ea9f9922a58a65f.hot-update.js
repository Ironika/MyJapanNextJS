...
var Animes = function Animes(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    window.onscroll = lodash_debounce__WEBPACK_IMPORTED_MODULE_4___default()(function () {
      ...
      if (scroll === document.documentElement.offsetHeight) loadItems(_animes);
    }, 100);
  }, [deepLoader]);

  var loadItems = function loadItems(an) {
    console.log(an); // let nbToDisplay = displayedAnimes.length + pageToDisplay
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          if (context.req) {// const animes = await getAnimes();
            // return {animes}
          }
...
//# sourceMappingURL=animes.js.65661ea9f9922a58a65f.hot-update.js.map